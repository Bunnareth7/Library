...
<head>
    ...
    <style>
        ...
        .banner {
            background: url('{{ asset("images/library.jpg") }}') no-repeat center center;
...
<body>
    ...
    <div class="container card-container mt-4">
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="card">
                <img src="{{ asset('images/book1.png') }}" class="card-img-top" alt="Card 1">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="{{ asset('images/student1.png') }}" class="card-img-top" alt="Card 2">
            ...
            <div class="col-md-4">
                <div class="card">
                    <img src="{{ asset('images/librarian.png') }}" class="card-img-top" alt="Card 3">
                    <div class="card-body">
