...
class LibrarianController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('librarians.index')->with('succes', 'Librarian created successfully');
    }
    ...
    public function update(Request $request, Librarian $librarian)
    {
        ...
        return redirect()-> route('librarians.index')-> with('succes','Librarian updates successfully.');
    }
