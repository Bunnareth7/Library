...
class BorrowingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('borrowings.index')->with('succes', 'Borrowing created successfully');
    }
    ...
    public function update(Request $request, Borrowing $borrowing)
    {
        ...
        return redirect()-> route('borrowings.index')-> with('succes','Borrowing updates successfully.');
    }
